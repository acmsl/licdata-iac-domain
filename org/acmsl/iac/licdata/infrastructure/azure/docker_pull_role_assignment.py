...
"""
org/acmsl/iac/licdata/infrastructure/azure/docker_pull_role_assignment.py
...
class DockerPullRoleAssignment(AzureResource):
    ...
    def __init__(
        ...
        :type roleDefinition: org.acmsl.iac.licdata.infrastructure.azure.RoleDefinition
